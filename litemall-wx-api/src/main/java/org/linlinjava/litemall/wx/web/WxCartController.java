...
import static org.linlinjava.litemall.wx.model.wxpay.WxResponseCode.GOODS_NO_STOCK;
import static org.linlinjava.litemall.wx.model.wxpay.WxResponseCode.GOODS_UNSHELVE;
...
public class WxCartController {
	 ...
	 *
	 * @param userId    用户ID
	 * @param cartId    购物车商品ID： 如果购物车商品ID是空，则下单当前用户所有购物车商品；
	...
	public Object checkout(@LoginUser Integer userId, Integer cartId, Integer addressId, Integer couponId,
		...
		for (LitemallCouponUser couponUser : couponUserList) {
			LitemallCoupon coupon = couponVerifyService.checkCoupon(userId, couponUser.getCouponId(),
					checkedGoodsPrice);
			if (coupon == null) {
				continue;
			}
