...
public class LitemallGoodsService {
	...
	Column[] columns = new Column[] {
		Column.id, Column.name, Column.brief, Column.picUrl, Column.isHot, Column.isNew, Column.counterPrice, Column.retailPrice
	};
	...
	public List<LitemallGoods> querySelective(Integer catId, Integer brandId,
		String keywords, Boolean isHot, Boolean isNew,
	...
	public List<LitemallGoods> querySelective(String goodsSn, String name,
