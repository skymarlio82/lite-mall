...
public class LitemallCouponUserService {
    ...
    public List<LitemallCouponUser> queryList(Integer userId, Integer couponId, Short status,
    ...
    public LitemallCouponUser queryOne(Integer userId, Integer couponId) {
        List<LitemallCouponUser> couponUserList = queryList(userId, couponId, CouponUserConstant.STATUS_USABLE,
            1, 1, "add_time", "desc");
