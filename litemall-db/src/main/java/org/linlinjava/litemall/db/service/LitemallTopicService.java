...
public class LitemallTopicService {
    ...
    private Column[] columns = new Column[]{
        Column.id, Column.title, Column.subtitle, Column.price, Column.picUrl, Column.readCount
    };
    ...
    public List<LitemallTopic> querySelective(String title, String subtitle,
